                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="data-apotik">
                        ...
                        <table class="table" id="dataTable">
                            ...
                            <tbody>
                                <?php foreach ($apotikData as $apotik) : ?>
                                    <tr>
                                        <td><?= $apotik['name']; ?></td>
                                        <td><?= $apotik['contact']; ?></td>
                                        <td><?= $apotik['address']; ?></td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?= base_url('edit-apotik/' . $apotik['id']); ?>" class="btn btn-warning">Edit</a>
                                                <a href="<?= base_url('delete-apotik/' . $apotik['id']); ?>" class="btn btn-danger">Delete</a>
                                            </div>
                                        </td>
