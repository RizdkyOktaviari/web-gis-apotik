    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                ...
                <br>
                <br>
                <center><img src="btg.png" alt="bontanglogo" width="150px"> </center>
                <br>
                <h2>
                    <center><b>SISTEM INFORMASI GEOGRAFIS </b> </center>
                </h2>
                <h2>
                    <center><b>APOTEK KOTA BONTANG</b> </center>
                </h2>
                <h2>
                    <center><button class="btn btn-dark" type="button" onclick="window.location.href='<?= base_url('home'); ?>'">Lihat Web</button></center>
                </h2>
